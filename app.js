...
function GetCurrentData() {
  ...
  .then((position) => {
    ...
    function weatherData(payload) {
      ...
      var WebCurrentWindSpeed = getWindDescription(WebCurrentData.WindSpeed).daDK +' ('+(WebCurrentData.WindSpeed / 3.6).toString().substring(0,4) + 'm/s)';// + MinutelyUnits.wind_speed_10m+ ')';
...
function GetDailyForecastData() {
  ...
  .then((position) => {
    ...
    function weatherData(payload) {
      ...
      var WebDailyWindSpeed = (DailyDataObj.wind_speed_10m_max[0] / 3.6).toString().substring(0,4) + 'm/s';//DailyUnits.wind_speed_10m_max;
      var WebDailyWindGusts = (DailyDataObj.wind_gusts_10m_max[0] / 3.6).toString().substring(0,4) + 'm/s';//DailyUnits.wind_gusts_10m_max;
