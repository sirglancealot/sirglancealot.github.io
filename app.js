...
function forecastData() {
  ...
  .then((position) => {
    ...
    function weatherData(payload) {
      ...
      var WebPositionLink = '<a href="https://maps.google.com/?q='+BrowserLatitude+','+BrowserLongitude+'">Browser position, latitude: '+ BrowserLatitude +' longitude: '+BrowserLongitude+'</a>';
